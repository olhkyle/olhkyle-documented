...
export default function NavLink({ link, currentPath, onClick }: NavLinkProps) {
	...
	return (
		<div
			className={`relative flex items-center px-2 py-1 text-xl font-bold ${isNavLinkCurrentPath} cursor-pointer hover:underline hover:underline-offset-[8px] min-w-[110px]`}
			onClick={onClick}>
