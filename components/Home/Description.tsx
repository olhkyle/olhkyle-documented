export default function Description() {
	return (
		<div className="mt-10 mb-8">
			<p className="flex justify-between gap-5 mx-2 py-6 px-12 w-[350px] bg-blue-300 text-blue-200 text-lg font-semibold text-center rounded-full sm:mt-8 sm:text-xl sm:w-[540px]">
